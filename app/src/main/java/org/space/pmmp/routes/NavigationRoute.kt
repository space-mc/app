...
sealed class NavigationRoute(var route: String, val icon: ImageVector?, var title: Int) {
    ...
    data object Console :
        NavigationRoute("Console", Icons.Filled.Terminal, R.string.console_route_title)

    data object Settings :
        NavigationRoute("Settings", Icons.Filled.Settings, R.string.settings_route_title)
}
